...
class BaseRobot:
    def __init__(self, name: str, weight: int, coords: list[int] = [0, 0]):
        self.name = name
        self.weight = weight
        self.coords = coords
...
class FlyingRobot(BaseRobot):
    def __init__(self, name: str, weight: int, coords: list[int] = [0, 0, 0]):
...
class DeliveryDrone(FlyingRobot):
    def __init__(self, name: str, weight: int, coords: list[int], max_load_weight: int, current_load: Cargo = None):
